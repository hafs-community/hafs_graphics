...
#print('ur_p= ',np.shape(np.flipud(np.rot90(ur_p_mean,1))))
#print('w_p= ',np.shape(np.flipud(np.rot90(w_p_mean,1))))
#print('R= ',np.shape(r))
#rsize=len(r)
#print('zlevs= ',np.shape(zlevs))
...
wb = ax.quiver(r1[::skipz,::skipr], z1[::skipz,::skipr], np.flipud(np.rot90(ur_p_mean,1))[::skipz,::skipr], np.flipud(np.rot90(w_p_mean*5.0,1))[::skipz,::skipr],
