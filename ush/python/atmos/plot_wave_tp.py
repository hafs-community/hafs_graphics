...
if conf['fhour'] == 0:
    ...
    os.system('wgrib2 -v '+ fname + ' -match "(PERPW):(surface:anl)" -netcdf ' + tmp_file_mp)
    ...
    os.system('wgrib2 -v '+ fname + ' -match "(PERPW):(surface:' + str(conf['fhour']) + ')" ' + '-netcdf ' + tmp_file_mp)
...
#===================================================================================================
print('Plotting primary wave mean period')
