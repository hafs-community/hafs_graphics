...
"""This script plots out the HAFS total rainfall swath, based on the 3-hours accumulated precipitation from the grid01 files."""
...
#===================================================================================================
print('Obtaining the mask along the forecasted track, around 500 km from the storm center') 
