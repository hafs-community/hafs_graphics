...
fig_name = fig_prefix+'.storm.'+'crs_we_reflectivity.'+conf['fhhh'].lower()+'.png'
cbshrink = 1.0
skip = 20
wblength = 5
...
cs2 = ax1.contourf(newlons, levs, ( refdtmp[:, idx[0], 300:700] ), colors=cfcolors, levels=cflevels, extend='max')
...
var_info = 'Simulated Radar Reflectivity (dBZ) X-section at '+str(clatpr)
...
ax1.set_title(title_left, loc='left', y=0.96)
...
ax1.text(1.0,-0.1, footer, fontsize=12, va="top", ha="right", transform=ax1.transAxes)
