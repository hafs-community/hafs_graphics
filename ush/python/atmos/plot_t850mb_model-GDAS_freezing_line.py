...
print('Parse the config file: plot_atmos_model-GDAS.yml:')
with open('plot_atmos_model-GDAS.yml', 'rt') as f:
...
tmp_gdas = gaussian_filter(tmp_gdas, 2)

#===================================================================================================
print('Plotting 850 mbar temperature')
fig_prefix = conf['model'] + '-GDAS'
...
ax.contour(lon, lat, tmp, levels=[0], colors='grey', linewidths=2)
plt.plot([0], [0], color='grey', lw=2, label=conf['model'])
