"""
 ...
 -------------
    ...
    extract SSS and plot in time series.


 ************************************************************************
 usage: python plot_sss.py stormModel stormName stormID YMDH trackon COMhafs graphdir
 -----
 ************************************************************************
...
for k in range(count):
   ...
   title_center = 'Sea Surface Salinity (psu)'
